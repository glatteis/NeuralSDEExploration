...
variable_args=(
    "-m exp --eta 0.01 --learning-rate 0.005 --latent-dims 1 --hidden-size 32 --noise 0.01 --decay 0.999"
    "-m const --eta 0.01 --learning-rate 0.005 --latent-dims 1 --hidden-size 32 --noise 0.01 --decay 0.999"
    "-m diffusion --eta 0.01 --learning-rate 0.005 --latent-dims 1 --hidden-size 32 --noise 0.01 --decay 0.999"
    "-m sin --eta 0.01 --learning-rate 0.005 --latent-dims 3 --hidden-size 32 --noise 0.01 --decay 0.999"
)
