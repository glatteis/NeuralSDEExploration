...
variable_args=(
    ...
    # beta cycling
    "--eta 10.0 --learning-rate 0.015 --latent-dims 3 --hidden-size 64"
    "--eta 100.0 --learning-rate 0.015 --latent-dims 3 --hidden-size 64"
    
    # latent dimension
    "--eta 50.0 --learning-rate 0.015 --latent-dims 2 --hidden-size 64"
